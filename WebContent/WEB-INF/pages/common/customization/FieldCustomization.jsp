...
<ps:set name="live_search_obj_cust_key_var" value="%{getEscText('live_search_obj_cust_key')}"/>
...
<ps:form id="customizationMaintForm_${_pageRef}" applyChangeTrack="true">
	...
	<script type="text/javascript">
		...
		/*953614 Specify Grid Filter Query Expression - Grid/Livesearch Customization Enhancements*/
		var live_search_obj_cust_key= '<ps:property value="live_search_obj_cust_key_var" escapeHtml="false" escapeJavaScript="true"/>';
		$(document).ready(function(){
		    manageHidingLvSrchBtn("${elemId}");
		});
			       ...
			       <table cellpadding="0" cellspacing="0">
						<tr>
							...
							<ps:if test='%{custActionType!=null && custActionType=="R"}'>
								...
								<%/*953614 Specify Grid Filter Query Expression - Grid/Livesearch Customization Enhancements*/%>
								<ps:if test='%{"1".equals(fromLiveSearch)}'>
									<td>
										<psj:a button="true" id="live_search_op_cust_from_${elemId}" onclick="openObjectCustPage('${elemId}');"  >
												<ps:label key="live_search_obj_cust_key"/>
										</psj:a>
									</td>
								          <td width="30"></td>
									</ps:if>
